...
# Load MP3 file
audio = AudioSegment.from_mp3("/media/payal/New Volume/SEM 5/DSIP/Haan Kar De (PenduJatt.Com.Se).mp3")
...
convoluted_audio = AudioSegment(convoluted_int16.tobytes(),
...
plt.title("Convoluted Audio Signal with Kernel [1, -1, 0, 1, -1]")
plt.tight_layout()
plt.show()